...
class WordsBaseViewController: NSViewController, LollyProtocol, NSTableViewDataSource, NSTableViewDelegate, NSTextFieldDelegate, WKNavigationDelegate {
...
class WordsBaseWindowController: NSWindowController, LollyProtocol {
